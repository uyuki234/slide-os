#pragma once
#include <stdint.h>
/* 8x16ビットマップフォント (ASCII 0x20-0x7E, 95文字)
 * 出典: QEMU同梱 vgabios-stdvga.bin (SeaVGABIOS, LGPL) から抽出。
 * グリフ自体は伝統的なIBM PC (CP437) 8x16フォントの字形。
 * 抽出スクリプト: tools/extract_font.py (オフセット0x7460, 検証済み) */
static const uint8_t font8x16[95][16] = {
    ...
    {0x00, 0x30, 0x30, 0x30, 0x60, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, /* quote */
